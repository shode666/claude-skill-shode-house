...
- ยังไม่ทำในรุ่นนี้: Cursor/Antigravity/Codex runtime จริง, Cowork drag-drop `.plugin`, live re-run ที่พิสูจน์ว่า tier/AC-bound finding ลดต้นทุน T-1 จริง (structural เท่านั้น — ตัวเลข 88 นาที/~$40 คือ baseline ให้รอบหน้าเทียบ)
