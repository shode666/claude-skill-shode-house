...
Fast path floor = Dave alone, targeted test as evidence; never lighter than the harness Bounded tier's exclusions (UI · money/auth/PII/external integration · schema or migration): any one moves the task up to Bounded, where Chris reviews. Between the two, depth follows the harness risk tier.
