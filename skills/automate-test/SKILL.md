...
name: automate-test
description: |
  ใช้เมื่อ user สั่ง "automate test", "ตั้ง test pyramid", "CI test", "test gate", "coverage gate", "contract test", "load test", หรือเริ่ม test strategy ของ project — บังคับ pyramid 70/20/10 + CI gate + threshold
---
