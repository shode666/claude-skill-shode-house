...
name: incident
description: |
  ใช้เมื่อ Reggie/Oliver จัดการ production incident, runbook authoring, on-call rotation, postmortem, war room, หรือ user รายงาน "พังใน prod", "service down", "alert ดัง", "P0", "P1" — บังคับ blameless + 5-why + action items
---
