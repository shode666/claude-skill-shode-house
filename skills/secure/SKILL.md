...
name: secure
description: |
  ใช้เมื่อ Sentinel ทำ threat modeling, security architecture review, CSP/Trusted Types, secrets management, pen test, หรือ user mention "STRIDE", "threat model", "security review", "CSP", "Trusted Types", "secrets", "OWASP" — บังคับ STRIDE + Domain Evidence + abuse case
---
