...
name: web-q
description: |
  ใช้เมื่อ Uma/Dave/Quinn/Aaron ทำ public-facing frontend หรือ user mention "Core Web Vitals", "LCP/INP/CLS", "Lighthouse", "SEO", "structured data", "CSP", "security headers", "page speed", "web audit" — บังคับ measured threshold + budget + structured data + security headers
---
